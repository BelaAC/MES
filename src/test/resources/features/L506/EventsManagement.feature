...
Feature: MES - L506 - EventsManagements

@Low-priority
@Packaging
@L506
@EventsManagements
	Scenario: Check Events Radio button	- L506
...
@L506
@EventsManagements
	Scenario: Create, Categorize, Split and Delete a Event	- L506
...
@L506
@EventsManagements
	Scenario: Multi Categorize and Delete Event - L506
		And I login as High Priority ADM in "Packaging"
		And I select the line L506
...
@L506
@EventsManagements	
	Scenario: Translation - GU QA - L506
		And I login as High Priority ADM in "Packaging"
		And I select the line L506
...
@L506
@EventsManagements
	Scenario: Filter working - GU QA - L506
		And I login as High Priority ADM in "Packaging"
		And I select the line L506
		And I select the Events button

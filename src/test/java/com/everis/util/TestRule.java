...
public class TestRule extends TestWatcher {
	...
	public static String downloadPath = new String();
	...
	protected void starting(Description description) {
		...
		String diff = LocalDateTime.now().toString();
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter(
				"target/report/html/" + description.getDisplayName().replace("tests.", "")
						+ diff.replace(":", "_").replace(".", "_") + ".html");
	...
	public static void openApplicationChrome(String url) {
		...
		String downloadFilepath = System.getProperty("user.dir") + "\\target\\temp";
	...
	public static void openApplicationChromeMobile(String url) {
		...
		try {
			driver = new RemoteWebDriver(new URL("http://" + Utils.getTestProperty("selenium.host") + ":4444/wd/hub"),
					capabilities);
		} catch (Exception e) {
			driver = new ChromeDriver(capabilities);
		}

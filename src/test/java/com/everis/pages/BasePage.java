...
public class BasePage {
	...
	public static List<String> correctEventsList() {
		...
		correctEventExternalCauses.add("Logística");
	...
	public static List<String> correctDefinitionOptionsDowntimeList() {
		...
		correctEventDowntimePlanned.add("Manutenção Programada");
		correctEventDowntimePlanned.add("Módulo de Manutenção");
		correctEventDowntimePlanned.add("Setup de Embalagem Secundária");
		correctEventDowntimePlanned.add("Setup");
		correctEventDowntimePlanned.add("CIP 1 (Enxágüe)");
		correctEventDowntimePlanned.add("CIP 2 (Alcalino)");
		correctEventDowntimePlanned.add("CIP-3 (Ácido)");
		correctEventDowntimePlanned.add("Assepsia Externa (Espuma)");
		correctEventDowntimePlanned.add("Scrubbing");
		correctEventDowntimePlanned.add("Inventário");
		correctEventDowntimePlanned.add("Início");
		correctEventDowntimePlanned.add("Final");
		correctEventDowntimePlanned.add("Corte de Produção");
